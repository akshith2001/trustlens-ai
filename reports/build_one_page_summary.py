...
def build_docx():
    ...
    values = ("0.656", "0.833", "0.407", "123 vs 300", "Passing suite")
...
def build_pdf():
    ...
    metrics_data = [[Paragraph(x, small_header) for x in ("Balanced accuracy", "Higher-risk recall", "Precision", "Weighted cost", "Automated tests")], [Paragraph(f"<b>{x}</b>", small) for x in ("0.656", "0.833", "0.407", "123 vs 300", "Passing suite")]]
